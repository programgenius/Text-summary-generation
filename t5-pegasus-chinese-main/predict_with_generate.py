...
def init_argument():
    ...
    parser.add_argument('--test_data', default='C:/Users\Administrator\Desktop/test2.tsv') # 测试集
    parser.add_argument('--result_file', default='./data/predict_result.tsv') # 结果文置,#F:\t5-pegasus-chinese-main\data
    parser.add_argument('--pretrain_model', default='F:/chinese_t5_pegasus_base')
    parser.add_argument('--model', default='F:/output/summary_model') # 训练后的模型权重文件
